    ...
    return (
        <nav className="flex items-center justify-center gap-1">
            <Link
             ...
             className={`flex ietms-center px-3 py-2 text-sm font-medium rounded-lg ${currentPage >= totalPages ? "text-gray-400 cursor-not-allowed bg-gray-400" 
            ...
            {visiblePages.map((page, key) => {
                if (page === "...") {
                    return (
                        <span key={key} className="px-3 py-3 text-sm text-gray-500">...</span>
                    );
                }
